...
void UWaveVRInputFunctionLibrary::RequestBumperInput(EWVR_DeviceType device, bool request)
{
	EWVR_DeviceType _device = GetLeftHandedDevice(device);

	UWaveVRBlueprintFunctionLibrary::RequestBumperInput(_device, request);
}
