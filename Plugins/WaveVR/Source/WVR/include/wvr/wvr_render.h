 ...
 *
 * Aggregate custom informations of foveated rendering. Using in @ref WVR_PreRenderEye.
 */
typedef struct WVR_RenderFoveationParams {
    ...
    WVR_PeripheralQuality periQuality;               /**< **periQuality**: The peripheral quality of foveated rendering. */
...
* This function must be called after calling WVR_RenderInit.
*
* @retval true foveated rendering feature is enabled.
* @retval false foveated rendering feature is enabled.
* @version API Level 5
*/
extern WVR_EXPORT bool WVR_IsRenderFoveationEnabled();

/**
* @brief Check whether foveated rendering is enabled or disabled when using default mode.
*
* This function must be called after calling WVR_RenderInit.
*
* @retval true foveated rendering is enable when using default mode.
* @retval false fvoeated rendering is disable when using default mode.
* @version API Level 5
*/
...
/**
* @brief Switch foveated rendering mode.
*
* Using to enable or disable foveated rendering or set to deafult mode.
* And developer need to call @ref WVR_PreRenderEye to take foveated effect on texture.
* This function is platform-depent, must call @ref WVR_IsRenderFoveationSupport to check does this platform support this.
* This function must be called after calling WVR_RenderInit.
*
* @param mode Switch foveated rendering mode.
* @retval WVR_Success switch mode successfully.
...
/**
* @brief Set foveated rendering config.
*
* Need to be called before WVR_PreRenderEye to let config take place on same frame.
* This function must be called after calling WVR_RenderInit.
*
* @param eye WVR_Eye, eye id to specify the side of scene.
* @param foveatedParam Foveated rendering config
* @retval WVR_Success set config successfully.
* @retval others @ref WVR_Result mean failure.
* @version API Level 5
*/
...
/**
* @brief Get default foveated rendering config of this device.
*
...
* @param eye WVR_Eye, eye id to specify the side of scene.
* @param foveatedParam Foveated rendering config
* @retval WVR_Success get config successfully.
* @retval others @ref WVR_Result mean failure.
* @version API Level 5
*/
