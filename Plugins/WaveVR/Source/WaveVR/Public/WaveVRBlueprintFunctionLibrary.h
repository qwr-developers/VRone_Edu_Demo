...
static const int InputButtonCount = 16;
...
public:
	...
	// To show if the foveated render feature is enabled or not.
	UFUNCTION(BlueprintCallable, Category = "WaveVR|Foveation")
	...
	UFUNCTION(BlueprintCallable, Category = "WaveVR|Foveation", meta=(DeprecatedFunction, DeprecationMessage = "Please use SetFoveationMode instead."))
	...
	// To enable or disable the AdaptiveQuality feature with event sent and/or auto adjust foveation. The AutoFoveation will override foveation mode.
	UFUNCTION(BlueprintCallable, Category = "WaveVR|AdaptiveQuality")
	static bool EnableAdaptiveQuality(bool enable, bool SendQualityEvent, bool AutoFoveation);
