...
UENUM(BlueprintType, Category = "WaveVR|Gesture")
enum class EWaveVRStaticGesture : uint8
{
	TYPE_INVALID	= 0,//WVR_HandGestureType::WVR_HandGestureType_Invalid,	/**< The gesture is invalid. */
	TYPE_UNKNOWN	= WVR_HandGestureType::WVR_HandGestureType_Unknown,    /**< Unknow gesture type. */
	TYPE_FIST		= WVR_HandGestureType::WVR_HandGestureType_Fist,    /**< Represent fist gesture. */
	TYPE_FIVE		= WVR_HandGestureType::WVR_HandGestureType_Five,    /**< Represent five gesture. */
	TYPE_OK			= WVR_HandGestureType::WVR_HandGestureType_OK,    /**< Represent ok gesture. */
	TYPE_LIKE		= WVR_HandGestureType::WVR_HandGestureType_ThumbUp,    /**< Represent thumb up gesture. */
	TYPE_POINT		= WVR_HandGestureType::WVR_HandGestureType_IndexUp,    /**< Represent index up gesture. */
};
...
UENUM(BlueprintType, Category = "WaveVR|Gesture|Hand")
...
UENUM(BlueprintType, Category = "WaveVR|Gesture|Finger")
...
UENUM(BlueprintType, Category = "WaveVR|Gesture|Bone")
