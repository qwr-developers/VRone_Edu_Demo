...
public:
	...
	virtual WVR_Result GetHandTrackingData(WVR_HandSkeletonData_t *skeleton, WVR_HandPoseData_t* pose = nullptr, WVR_PoseOriginModel type = WVR_PoseOriginModel_OriginOnHead) override;
