...
WVR_Result FWaveVRPlatformAndroid::GetHandTrackingData(WVR_HandSkeletonData_t *skeleton, WVR_HandPoseData_t* pose, WVR_PoseOriginModel type) {
	return WVR_GetHandTrackingData(skeleton, pose, type);
}
